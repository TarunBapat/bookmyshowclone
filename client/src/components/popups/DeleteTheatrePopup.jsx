...
const DeleteTheatrePopup = ({ deleteKey, setPopups }) => {
  async function deleteHandler(theatreId) {
    try {
      const response = await Api.deleteMovie(theatreId);
        ...
        <div className="flex justify-center space-x-4">
          <button
            onClick={() => {
              ...
              setPopups((prev) => {
                return { ...prev, deleteTheatre: false };
              });
            }}
